...
//-----------------------------------------------------------------------
class CExplosionParticleSystem
{
protected:
	UINT m_NumParticles;
...
public:
	CExplosionParticleSystem();
	virtual         ~CExplosionParticleSystem();
...
//-----------------------------------------------------------------------
class CMushroomParticleSystem : public CExplosionParticleSystem
{
public:
...
//-----------------------------------------------------------------------
class CStalkParticleSystem : public CExplosionParticleSystem
{
public:
...
//-----------------------------------------------------------------------
class CGroundBurstParticleSystem : public CExplosionParticleSystem
{
public:
...
//-----------------------------------------------------------------------
class CLandMineParticleSystem : public CExplosionParticleSystem
{
public:
