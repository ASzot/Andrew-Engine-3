...
//--------------------------------------------------------------------------------------
void SetNumActiveParticles(UINT numParticles)
{
...
//-----------------------------------------------------------------------
CExplosionParticleSystem::CExplosionParticleSystem()
{
	m_NumParticles = 0;
	m_pParticles = NULL;
...
//--------------------------------------------------------------------------------------
HRESULT CExplosionParticleSystem::CreateParticleSystem( UINT NumParticles )
{
...
//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::SetSystemAttributes( D3DXVECTOR3 vCenter,
...
//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::SetCenter( D3DXVECTOR3 vCenter )
{
	m_vCenter = vCenter;
}

//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::SetStartTime( float fStartTime )
{
	m_fStartTime = fStartTime;
}

//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::SetStartSpeed( float fStartSpeed )
{
	m_fStartSpeed = fStartSpeed;
}

//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::SetFlashColor( D3DXVECTOR4 vFlashColor )
{
	m_vFlashColor = vFlashColor;
}

//--------------------------------------------------------------------------------------
D3DXVECTOR4 CExplosionParticleSystem::GetFlashColor()
{
	return m_vFlashColor;
}

//--------------------------------------------------------------------------------------
float CExplosionParticleSystem::GetCurrentTime()
{
	return m_fCurrentTime;
}

//--------------------------------------------------------------------------------------
float CExplosionParticleSystem::GetLifeSpan()
{
	return m_fLifeSpan;
}

//--------------------------------------------------------------------------------------
UINT CExplosionParticleSystem::GetNumParticles()
{
	return m_NumParticles;
}

//--------------------------------------------------------------------------------------
D3DXVECTOR3 CExplosionParticleSystem::GetCenter()
{
	return m_vCenter;
}

//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::Init()
{
...
//--------------------------------------------------------------------------------------
void CExplosionParticleSystem::AdvanceSystem( float fTime, float fElapsedTime, D3DXVECTOR3 vRight, D3DXVECTOR3 vUp,
...
//-----------------------------------------------------------------------
CMushroomParticleSystem::CMushroomParticleSystem() : CExplosionParticleSystem()
{
	m_PST = PST_MUSHROOM;
}
...
//-----------------------------------------------------------------------
CStalkParticleSystem::CStalkParticleSystem() : CExplosionParticleSystem()
{
	m_PST = PST_STALK;
}
...
//-----------------------------------------------------------------------
CGroundBurstParticleSystem::CGroundBurstParticleSystem() : CExplosionParticleSystem()
{
	m_PST = PST_GROUNDEXP;
}
...
//-----------------------------------------------------------------------
CLandMineParticleSystem::CLandMineParticleSystem() : CExplosionParticleSystem()
{
	m_PST = PST_LANDMIND;
}
